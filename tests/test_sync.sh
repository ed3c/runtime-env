...
printf '%s\n' \
  '{"schema":"runtime-env/workload/v1","id":"local-proof","summary":"Fixture.","profile":"bettor-arena-local","host":"local-macos","entrypoints":{"prove":["sh","proof.sh"]},"secret_delivery":"none","agent_secret_access":"denied","mutation":"workspace","evidence":{"receipt":"receipt.json","control":"control.sh"}}' \
